...
<head>
    ...
    <title>Komponen Pesawat A350</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="image-container" data-aos="fade-up">
            <img src="{{ asset('gambar2.jpg') }}" alt="Pesawat A350">
        </div>
        <p class="text-description" >
            Pesawat A350 adalah salah satu pesawat berbadan sempit terbaik yang dirancang untuk penerbangan jarak menengah. Dengan kapasitas penumpang yang lebih besar dan teknologi modern, pesawat ini menjadi pilihan utama maskapai penerbangan.
        </p>
