        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-lg shadow-lg overflow-hidden" style="height: 40vh">
                ...
                <div class="text-center py-4">
                    <a class="text-blue-900 font-semibold text-lg hover:none">A321</a>
                </div>
            </div>
            <!-- Foto 2 -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden" style="height: 40vh">
                ...
                <div class="text-center py-4">
                    <a class="text-blue-900 font-semibold text-lg hover:none">A350</a>
                </div>
            </div>
            <!-- Foto 3 -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden" style="height: 40vh">
                ...
                <div class="text-center py-4">
                    <a class="text-blue-900 font-semibold text-lg hover:none">A380</a>
                </div>
            </div>
            <!-- Foto 1 -->
            <div class="bg-white rounded-lg shadow-lg overflow-hidden" style="height: 40vh">
