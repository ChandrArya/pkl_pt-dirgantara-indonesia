...
<body>
    ...
    <section class="bg-white py-6">
        <div class="container mx-auto px-6 lg:px-20">
            <h2 class="text-3xl md:text-4xl font-bold text-center text-blue-900 mb-8">A380</h2>
            <!-- Gambar Pesawat -->
            <div class="flex justify-center mb-8 image-container">
                <img src="{{ asset('gambar2.jpg') }}" class="w-full object-cover rounded-lg shadow-lg">
            </div>
