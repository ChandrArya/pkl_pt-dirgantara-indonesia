...
<head>
    ...
    <title>Komponen Pesawat A380</title>
...
<body>
    ...
    <div class="container">
        <h1 class="section-title" data-aos="fade-down">Pesawat A380</h1>
        <div class="image-container" data-aos="fade-up">
            <img src="{{ asset('gambar2.jpg') }}" alt="Pesawat A380">
        </div>
        <p class="text-description" >
            Pesawat A380 adalah salah satu pesawat berbadan sempit terbaik yang dirancang untuk penerbangan jarak menengah. Dengan kapasitas penumpang yang lebih besar dan teknologi modern, pesawat ini menjadi pilihan utama maskapai penerbangan.
        </p>
